...
if($(window).scrollTop()+100 >= skillsScrol){
    let skillPercent1 = $(".skillpercent1");
    let skillPercent2 = $(".skillpercent2");
    let skillPercent3 = $(".skillpercent3");
    skillPercent1.css("width","85%");
    skillPercent2.css("width","80%");
    skillPercent3.css("width","60%");

}};
    $(window).on("scroll", scrol);
